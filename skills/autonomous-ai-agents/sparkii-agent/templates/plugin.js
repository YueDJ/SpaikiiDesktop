/**
 * Sparkii desktop plugin template. Save as:
 *   <sparkii home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <sparkii home> is ~/.sparkii by default, or ~/.sparkii/profiles/<name>
 * when running a named profile (`sparkii -p <name>`). Run `sparkii doctor` (or
 ...
 * Only these imports resolve: @sparkii/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@sparkii/plugin-sdk'
