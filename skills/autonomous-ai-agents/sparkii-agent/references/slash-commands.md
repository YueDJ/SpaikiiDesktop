...
Registry of record: `sparkii_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Sparkii config+state snapshots (CLI)
...
/update                  Update Sparkii to latest
