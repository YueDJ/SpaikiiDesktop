...
Built for [Sparkii Agent](https://github.com/YueDJ/SparkiiAgent). Usable in any coding agent. Canonical source lives here; synced to [`YueDJ/SparkiiAgent/skills/creative/ascii-video`](https://github.com/YueDJ/SparkiiAgent/tree/main/skills/creative/ascii-video) via PR.
