...
Built for [Sparkii Agent](https://github.com/NousResearch/sparkii-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/sparkii-agent/skills/creative/ascii-video`](https://github.com/NousResearch/sparkii-agent/tree/main/skills/creative/ascii-video) via PR.
