...
Built for [Sparkii Agent](https://github.com/YueDJ/SpaikiiDesktop). Usable in any coding agent. Canonical source lives here; synced to [`YueDJ/SpaikiiDesktop/skills/creative/ascii-video`](https://github.com/YueDJ/SpaikiiDesktop/tree/main/skills/creative/ascii-video) via PR.
