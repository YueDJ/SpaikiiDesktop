...
- Frontmatter 字段：name、description、version、license、platforms、metadata（含 hermes.tags/related_skills 等）、prerequisites、required_environment_variables、setup 等。
...
### 元数据定义、依赖声明与版本管理
- 元数据：name/description/version/license/platforms/metadata.hermes.*。
- 依赖声明：
