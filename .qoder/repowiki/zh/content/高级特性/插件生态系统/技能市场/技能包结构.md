...
<cite>
**本文引用的文件**
- [SKILL.md](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md)
...
章节来源
- [SKILL.md:18-41](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L18-L41)
...
- 必填字段：name、description。推荐字段：version、author、license、platforms、metadata.sparkii.tags、metadata.sparkii.related_skills。
...
章节来源
- [SKILL.md:43-127](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L43-L127)
...
- [SKILL.md:106-111](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L106-L111)
...
章节来源
- [SKILL.md:93-105](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L93-L105)
...
- [SKILL.md:106-127](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L106-L127)

### 最佳实践与模板
- 将大段内容放入 references/templates/scripts，保持 SKILL.md 紧凑。
- 使用 Sparkii 原生工具（terminal、read_file、patch、search_files 等）而非裸 shell 命令。
...
章节来源
- [SKILL.md:112-135](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L112-L135)
- [SKILL.md:148-175](file://skills/software-development/sparkii-agent-skill-authoring/SKILL.md#L148-L175)
...
## 附录
- 快速清单
  - 使用 frontmatter 声明 name、description、version、author、license、platforms、metadata.sparkii
  - 将大内容放入 references/templates/scripts，保持 SKILL.md 精简
  - 使用 Sparkii 原生工具，避免裸 shell 命令
