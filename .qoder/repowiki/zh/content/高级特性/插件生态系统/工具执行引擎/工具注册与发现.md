...
- [tests/sparkii_cli/test_plugins.py](file://tests/sparkii_cli/test_plugins.py)
...
- 测试用例（覆盖冲突、MCP 动态刷新等）：tests/sparkii_cli/test_plugins.py、tests/tools/test_mcp_tool.py
...
- 测试覆盖冲突与 override：[tests/sparkii_cli/test_plugins.py](file://tests/sparkii_cli/test_plugins.py)
...
- [sparkii_cli/plugins.py:478-490](file://sparkii_cli/plugins.py#L478-L490)
- [tests/sparkii_cli/test_plugins.py:780-880](file://tests/sparkii_cli/test_plugins.py#L780-L880)
...
- 相关测试用例可作为最佳实践参考：
  - 冲突与覆盖：[tests/sparkii_cli/test_plugins.py](file://tests/sparkii_cli/test_plugins.py)
