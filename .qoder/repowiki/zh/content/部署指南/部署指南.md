...
participant Hook as "cont-init.d/01-hermes-setup"
participant Main as "main-hermes(s6服务)"
...
- 环境变量：HERMES_UID/HERMES_GID 用于宿主与容器 UID 映射；API_SERVER_HOST/API_SERVER_KEY 控制 API 服务器暴露与鉴权。
...
Init --> Setup["cont-init.d/01-hermes-setup<br/>UID/GID映射、chown、配置种子"]
Setup --> Services["s6-rc 启动服务<br/>main-hermes / dashboard"]
Services --> Ready{"服务就绪?"}
...
- 启动仪表盘：hermes dashboard --host 127.0.0.1 --no-open
