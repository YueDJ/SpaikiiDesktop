...
```python
# 示例：基本使用
from agent.mcp_deployment_configuration import MCP部署与配置
...
# 查看详细日志
sparkii logs --level DEBUG --session mcp-deployment-configuration

# 测试连接
sparkii test mcp-deployment-configuration
```
