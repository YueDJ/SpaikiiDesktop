...
- 可插拔CLI：优先HERMES_DOCKER_BINARY，其次PATH中的docker/podman，最后尝试已知安装路径。
...
- 远程目录准备：一次性mkdir创建~/.hermes/{skills,credentials,cache}。
