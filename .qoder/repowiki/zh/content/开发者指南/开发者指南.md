...
## 简介
本指南面向希望扩展与二次开发 Sparkii Desktop（Hermes Agent）的开发者，覆盖开发环境搭建、插件系统架构与扩展机制、工具与平台适配器开发流程、API 参考（REST/WebSocket/事件）、最佳实践与性能优化建议。文档以仓库实际代码为依据，提供可追溯的文件来源与图示，帮助不同经验水平的开发者快速上手并高质量地贡献代码。
...
- 调试：启用日志与诊断命令（如 hermes doctor），查看 Gateway/Agent 日志定位问题。
...
## 附录
- 常用命令参考：hermes model/tools/config/gateway/setup/update/doctor 等，详见 README。
- 文档中心：https://hermes-agent.nousresearch.com/docs/
