...
## 简介
创建多媒体处理工具的详细使用指南。介绍图像生成、视频处理、语音识别和合成等功能的使用方法。详细说明支持的格式、API集成和质量设置。解释资源消耗和性能考虑。提供实际示例展示如何批量处理媒体文件、生成创意内容、处理音频视频流。包含第三方服务配置和成本控制建议。...

本模块是 Sparkii/Sparkii Agent 系统的重要组成部分，负责多媒体处理工具的核心功能实现。
...
```python
# 示例：基本使用
from agent.multimedia_tools import 多媒体处理工具
...
# 查看详细日志
sparkii logs --level DEBUG --session multimedia-tools

# 测试连接
sparkii test multimedia-tools
```
