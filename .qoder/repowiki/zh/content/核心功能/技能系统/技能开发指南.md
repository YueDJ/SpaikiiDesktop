...
## 简介
本文提供 Sparkii Agent 技能（Skill）开发的完整指南。技能是 Agent 的可插拔能力扩展——每个技能是一个独立的 SKILL.md 文件，定义了特定任务的执行指令、工具使用规范和输出格式。
...
## 结论
技能开发是扩展 Sparkii Agent 能力的最轻量方式。通过标准化的 SKILL.md 格式和安全约束机制，开发者可以快速创建和分享技能，而无需修改系统核心代码。
