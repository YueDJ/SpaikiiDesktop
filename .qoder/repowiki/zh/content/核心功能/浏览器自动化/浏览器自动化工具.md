...
## 简介
本文详细阐述 Hermes Agent 的浏览器自动化工具集，即 browser_use、open_preview、computer_use 等工具的完整功能。浏览器自动化是 Agent 与 Web 交互的核心能力，支持页面导航、元素操作、截图捕获、表单填写等丰富的浏览器控制操作。
...
## 结论
浏览器自动化工具是 Hermes Agent 与 Web 交互的核心能力。通过 browser_use 和 computer_use 两种工具模式，Agent 可以完成从简单的网页浏览到复杂的 UI 自动化测试等各种任务。开发者应根据具体场景选择合适的工具和配置。
