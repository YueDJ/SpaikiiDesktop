#!/usr/bin/env python3
"""
SWE Runner with Sparkii Trajectory Format

A runner that uses Sparkii-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Sparkii-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Sparkii-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Sparkii format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Sparkii-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Sparkii-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Sparkii Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Sparkii-Agent's built-in execution environments
    and outputs trajectories in Sparkii-Agent format.
    """
    ...
    def _convert_to_sparkii_format(
        self,
        ...
        """
        Convert internal message format to Sparkii trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Sparkii trajectory format
        trajectory = self._convert_to_sparkii_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Sparkii trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Sparkii Trajectory Format")
    print("=" * 60)
