...
| 优先级 | 文件 | 搜索范围 | 说明 |
|--------|------|----------|------|
| 1 | `.sparkii.md`、`HERMES.md` | 从 CWD 向上至 git 根目录 | Sparkii 原生项目配置 |
...
1. `.sparkii.md` / `HERMES.md`（向上遍历至 git 根目录）
...
- 项目上下文文件，如 `.sparkii.md`、`HERMES.md`、`AGENTS.md`、`CLAUDE.md` 或 `.cursorrules` — 注入仓库特定的工作规则。
