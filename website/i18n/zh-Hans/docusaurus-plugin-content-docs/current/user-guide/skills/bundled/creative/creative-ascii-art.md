...
```bash
python3 -m pyfiglet "SPARKII" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SPARKII&font=Slant" | boxes -d stone
```
