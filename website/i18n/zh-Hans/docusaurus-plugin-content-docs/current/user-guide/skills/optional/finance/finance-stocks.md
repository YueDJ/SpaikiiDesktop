...
| | |
|---|---|
| 来源 | 可选 — 使用 `sparkii skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Sparkii Agent |
| 许可证 | MIT |
...
```
SCRIPT=~/.sparkii/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.sparkii/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
