#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Sparkii docs site.
...
LLM reads to learn what Sparkii does.

Both publish at:
  https://sparkii-agent.nousresearch.com/docs/llms.txt
  https://sparkii-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://sparkii-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Sparkii as a Python Library", None),
        ("guides/use-mcp-with-sparkii", "Use MCP with Sparkii", None),
        ("guides/use-voice-mode-with-sparkii", "Use Voice Mode with Sparkii", None),
        ("guides/use-soul-with-sparkii", "Use SOUL.md with Sparkii", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Sparkii"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "sparkii-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/sparkii-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Sparkii Agent — Full Documentation\n",
        (
            "This file is the entire Sparkii Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Sparkii, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://sparkii-agent.nousresearch.com/docs\n",
        "Short index: https://sparkii-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
