...
Both take the same `SparkiiPlugin` contract, appear in **Settings → Plugins**, and
...
| Plugin contract | `SparkiiPlugin`, `PluginContext`, `PluginContribution`, `PluginStorage`, `PluginOs`, `PluginRestOptions`, `PluginNativeNotificationInput`, `Contribution` |
