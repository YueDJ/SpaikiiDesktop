...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `sparkii_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `sparkii_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Sparkii Plugin](plugins/index.md) |
...
| Session storage | `sparkii_state.py` | [Session Storage](session-storage.md) |
