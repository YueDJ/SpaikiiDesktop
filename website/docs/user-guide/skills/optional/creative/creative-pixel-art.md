...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.sparkii/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.sparkii/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Sparkii installs package this)
