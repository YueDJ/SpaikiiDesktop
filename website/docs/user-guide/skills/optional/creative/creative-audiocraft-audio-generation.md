...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/creative/audiocraft-audio-generation` |
...
- **[Advanced Usage](https://github.com/NousResearch/sparkii-agent/blob/main/optional-skills/creative/audiocraft-audio-generation/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/NousResearch/sparkii-agent/blob/main/optional-skills/creative/audiocraft-audio-generation/references/troubleshooting.md)** - Common issues and solutions
