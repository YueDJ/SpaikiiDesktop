...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Sparkii Agent |
| License | MIT |
...
import upstream classes into Sparkii itself.
...
Open `~/.sparkii/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Sparkii core.
   Custom driver scripts under `~/.sparkii/skills/...` are user-side and fine.
