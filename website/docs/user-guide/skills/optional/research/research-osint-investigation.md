...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Sparkii Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $SPARKII_OSINT_CACHE/icij/ (default: ~/.cache/sparkii-osint/icij/).
...
# Set SPARKII_OSINT_UA=your-app/1.0 (your@email) to identify yourself
