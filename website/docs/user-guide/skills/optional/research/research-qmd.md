...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`sparkii-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sparkii-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
