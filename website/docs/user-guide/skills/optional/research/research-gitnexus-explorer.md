...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/research/gitnexus-explorer` |
...
| Related skills | [`sparkii-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sparkii-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  sparkii-agent users don't need.
