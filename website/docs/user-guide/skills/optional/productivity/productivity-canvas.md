...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Sparkii Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${SPARKII_HOME:-~/.sparkii}/.env`:
