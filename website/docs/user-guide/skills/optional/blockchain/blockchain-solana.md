...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Sparkii Agent |
| License | MIT |
...
Helper script path: ~/.sparkii/skills/blockchain/solana/scripts/solana_client.py
