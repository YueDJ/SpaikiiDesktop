...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing sparkii tool access (web_search, file ops). Stateless. |
