...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/web-development/page-agent` |
...
- User wants **Sparkii itself to drive a browser** → use Sparkii' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
