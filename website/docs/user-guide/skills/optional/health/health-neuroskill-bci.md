...
| | |
|---|---|
| Source | Optional — install with `sparkii skills install official/health/neuroskill-bci` |
...
Connect Sparkii to a running [NeuroSkill](https://neuroskill.com/) instance to read
