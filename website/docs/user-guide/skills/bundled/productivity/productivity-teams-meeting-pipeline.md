...
3. **Set up automated renewal immediately** via `sparkii cron add`, a systemd timer, or plain crontab. The operator runbook has all three options. 12-hour interval is safe (6x headroom against the 72h limit).
