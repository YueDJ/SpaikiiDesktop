...
Set your Tenor API key in your environment (add to `${SPARKII_HOME:-~/.sparkii}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/sparkii-agent/blob/main/skills/media/gif-search/url)`
