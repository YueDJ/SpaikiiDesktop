...
- **You just want to back up a profile on your own machine.** Use [`sparkii profile export` / `import`](../reference/profile-commands.md#sparkii-profile-export) — that's what those are for.
...
- [`sparkii profile export` / `import`](../reference/profile-commands.md#sparkii-profile-export) — local backup / restore (not distribution)
