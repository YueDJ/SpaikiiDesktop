...
slug: /
sidebar_position: 0
title: "Sparkii Agent Documentation"
...
After installing, run `sparkii setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Sparkii Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Sparkii safely  |
| 🧭 **[Use MCP with Sparkii](/guides/use-mcp-with-sparkii)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Sparkii](/guides/use-voice-mode-with-sparkii)** | Hands-on setup and usage patterns for Sparkii voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Sparkii' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Sparkii                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Sparkii, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Sparkii, Nomos, and Psyche models
