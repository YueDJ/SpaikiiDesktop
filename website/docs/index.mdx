...
| 🧭 **[Use MCP with Sparkii](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Sparkii](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Sparkii voice workflows          |
