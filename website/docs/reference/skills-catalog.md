...
| [`sparkii-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sparkii-agent) | Use, configure, theme, extend, and orchestrate Sparkii Agent. | `autonomous-ai-agents/sparkii-agent` |
...
| [`sparkii-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-sparkii-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/sparkii-agent-skill-authoring` |
| [`inspecting-sparkii-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-sparkii-desktop-dom) | Read the live Sparkii desktop DOM/CSS over CDP. | `software-development/inspecting-sparkii-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .sparkii/plans/; no execution. | `software-development/plan` |
