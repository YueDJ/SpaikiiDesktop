...
If a model is genuinely missing, [open an issue](https://github.com/YueDJ/SparkiiAgent/issues) — we surface the Portal's catalog to Sparkii and gaps usually mean a routing config we can update.
