...
| **OpenAI Codex** | `sparkii model` (ChatGPT OAuth, uses Codex models) |
...
| **OpenAI Codex — ChatGPT plan OAuth** | ✅ Yes — `sparkii model` → OpenAI Codex (ChatGPT OAuth device-code login, uses Codex models) | *Not currently documented* | *Not currently documented* | Docs cover auth and token refresh only; plan-quota semantics are not yet documented |
