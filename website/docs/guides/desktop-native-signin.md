...
description: "How the Sparkii Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Sparkii Desktop app connects to a **gated gateway** (a hosted or
...
For Sparkii specifically, native sign-in means:
...
- [Run Sparkii with Nous Portal](./run-sparkii-with-nous-portal.md)
