...
DEFAULT_UA = (
    "sparkii-osint-investigation/0.2 "
    "(+https://github.com/YueDJ/SparkiiAgent; "
    "set SPARKII_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("SPARKII_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
