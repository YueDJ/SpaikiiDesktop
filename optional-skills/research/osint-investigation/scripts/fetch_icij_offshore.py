...
$SPARKII_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/) and search
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Override cache directory (default: $SPARKII_OSINT_CACHE/icij or ~/.cache/hermes-osint/icij)",
    )
    p.add_argument(
        "--force-refresh",
        action="store_true",
