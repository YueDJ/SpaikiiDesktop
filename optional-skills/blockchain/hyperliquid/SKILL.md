...
```bash
python ~/.sparkii/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.sparkii/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.sparkii/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
