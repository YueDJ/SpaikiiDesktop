...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("SPARKII_HOME", os.path.expanduser("~/.hermes")), "skills/red-teaming/godmode/scripts/auto_jailbreak.py")
    )).read())
...
try:
    ...
    _SKILL_DIR = Path(os.getenv("SPARKII_HOME", Path.home() / ".hermes")) / "skills" / "red-teaming" / "godmode"
