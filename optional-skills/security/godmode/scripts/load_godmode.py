...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("SPARKII_HOME", os.path.expanduser("~/.hermes")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("SPARKII_HOME", Path.home() / ".hermes")) / "skills" / "red-teaming" / "godmode" / "scripts"
