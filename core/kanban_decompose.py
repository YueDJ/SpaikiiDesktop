# Moved from sparkii_cli/kanban_decompose.py during the Block 4 split; the CLI module is now a shim over this file.

"""Kanban decomposer — fan a triage task out into a graph of child tasks.

Invoked by ``sparkii kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Sparkii Agent board.
...
def _profile_author() -> str:
    """Mirror of ``sparkii_cli.kanban._profile_author``."""
    return (
