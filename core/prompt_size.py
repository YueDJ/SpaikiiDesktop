# Moved from sparkii_cli/prompt_size.py during the Block 4 split; the CLI module is now a shim over this file.

"""Prompt-size diagnostic: ``sparkii prompt-size``.
...
def cmd_prompt_size(args: Any) -> None:
    """Entry point for ``sparkii prompt-size``."""
