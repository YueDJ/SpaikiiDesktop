# Moved from sparkii_cli/middleware.py during the Block 4 split; the CLI module is now a shim over this file.

"""Sparkii middleware contract helpers.
...
MIDDLEWARE_SCHEMA_VERSION = "sparkii.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Sparkii sends them.
    """
