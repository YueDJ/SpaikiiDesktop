...
Trust levels:
  - builtin:   Ships with Sparkii. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.sparkii/\.env|\~/\.sparkii/\.env',
     "sparkii_env_access", "critical", "exfiltration",
     "directly references Sparkii secrets file"),
    ...
    (r'\.sparkii/config\.yaml|\.sparkii/SOUL\.md',
     "sparkii_config_mod", "critical", "persistence",
     "references Sparkii configuration files directly"),
...
# scan. `.skillignore` is the Sparkii-native name; `.clawhubignore` is honored
