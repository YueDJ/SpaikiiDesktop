...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.sparkii)."""
    from sparkii_constants import get_sparkii_dir

    return get_sparkii_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Sparkii subagent live transcript ===",
