#!/usr/bin/env python3
"""Apply a layout preset in the Sparkii desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the Sparkii desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the Sparkii desktop app when the user asks to "
