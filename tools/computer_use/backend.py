...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of YueDJ/SparkiiAgent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of YueDJ/SparkiiAgent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (YueDJ/SparkiiAgent#67052). ``ok`` stays
