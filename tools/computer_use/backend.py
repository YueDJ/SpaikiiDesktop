...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of YueDJ/SpaikiiDesktop#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of YueDJ/SpaikiiDesktop#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (YueDJ/SpaikiiDesktop#67052). ``ok`` stays
