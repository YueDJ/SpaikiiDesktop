 ...
 *
 * Plugins call window.__SPARKII_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SPARKII_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SPARKII_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SPARKII_PLUGIN_SDK__ = {
    ...
    // window.__SPARKII_SESSION_TOKEN__ directly.
    authedFetch,
