 ...
 * `window.__SPARKII_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Sparkii brand in the top bar
 ...
 *  `window.__SPARKII_PLUGINS__.registerSlot(...)`.
 *
