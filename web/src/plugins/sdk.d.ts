/**
 * Sparkii Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SPARKII_PLUGIN_SDK__`` and
 * ``window.__SPARKII_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SPARKII_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SparkiiPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@sparkii/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SPARKII_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SPARKII_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SPARKII_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SparkiiPluginSDK {
...
declare global {
  interface Window {
    __SPARKII_PLUGIN_SDK__?: SparkiiPluginSDK;
    __SPARKII_PLUGINS__?: PluginRegistry;
  }
}
