...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    sparkii_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__sparkii_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Sparkii-Session-Token":
              (window as unknown as { __SPARKII_SESSION_TOKEN__?: string })
                .__SPARKII_SESSION_TOKEN__ ?? "",
          },
        });
