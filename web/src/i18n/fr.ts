...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateSparkii: "Mettre à jour Sparkii",
    updatingSparkii: "Mise à jour de Sparkii…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Sparkii (parité avec `sparkii plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.sparkii/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.sparkii/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.sparkii/skills/",
  ...
  config: {
    configPath: "~/.sparkii/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Variables d'environnement arbitraires stockées dans votre .env que Sparkii ne reconnaît pas. Utilisez-les pour injecter des variables d'environnement pour des compétences, des serveurs MCP ou vos propres outils.",
  ...
  achievements: {
    hero: {
      ...
      title: "Sparkii Achievements",
      subtitle:
        "Badges Sparkii à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Sparkii en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Sparkii davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Sparkii détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Sparkii analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Sparkii Agent ☤",
    },
  },
  kanban: {
