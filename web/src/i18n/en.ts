...
export const en: Translations = {
  ...
  status: {
    ...
    updateSparkiiConfirmMessage:
      "This runs sparkii update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateSparkiiConfirmNow: "Update now",
    updateSparkiiConfirmTitle: "Update Sparkii?",
    updatingSparkii: "Updating Sparkii…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Sparkii plugins (`sparkii plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.sparkii/plugins/?",
    removeHint: "Only user-installed plugins under ~/.sparkii/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.sparkii/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Sparkii doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Sparkii badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Sparkii session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Sparkii more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Sparkii sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Sparkii is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
