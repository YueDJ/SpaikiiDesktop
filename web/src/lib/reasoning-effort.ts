 ...
 *
 * Values mirror sparkii_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Sparkii default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Sparkii' default when unset). */
