...
const STORAGE_KEY = "sparkii-dashboard-theme";
...
const FONT_STORAGE_KEY = "sparkii-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `sparkii_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "sparkii-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-sparkii-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-sparkii-theme-font", "true");
