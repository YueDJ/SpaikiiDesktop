 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `sparkii_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Sparkii Teal",
  description: "Classic dark teal — the canonical Sparkii look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Sparkii Teal (Large)",
  description: "Sparkii Teal with bigger fonts and roomier spacing",
