...
def _profile_user_agent() -> str:
    """Return a ``sparkii-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from sparkii_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"sparkii-cli/{_ver}"
    except Exception:
        return "sparkii-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # sparkii-cli UA so the catalog endpoint is reachable.
