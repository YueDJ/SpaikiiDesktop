...
from sparkii_constants import get_sparkii_home, get_skills_dir, is_wsl
...
SPARKII_AGENT_HELP_GUIDANCE = (
    ...
    "the documentation at https://github.com/YueDJ/SparkiiDesktop/tree/main/website/docs is your "
...
def computer_use_guidance(platform_name: Optional[str] = None) -> str:
    ...
    return (
        ...
        "when Sparkii has none; explicit Sparkii YOLO uses a private unrestricted "
...
def load_soul_md(context_length: Optional[int] = None) -> Optional[str]:
    ...
    soul_path = get_sparkii_home() / "SOUL.md"
