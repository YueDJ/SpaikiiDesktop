"""Vertex AI (Google Cloud) adapter for Sparkii Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Sparkii to use Gemini models via Google Cloud with
...
# who installed plain `sparkii-agent` and only later selected a Gemini model.
try:
