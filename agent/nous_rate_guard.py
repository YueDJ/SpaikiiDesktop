...
(3 SDK retries x 3 Sparkii retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_sparkii_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".sparkii")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Sparkii, ...) behind one endpoint.  A 429 can mean either:
