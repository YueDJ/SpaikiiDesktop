...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if active_profile == "default":
        post_workspace_parts.append(
            ...
            "under " + str(get_sparkii_home()) + "/profiles/<name>/. Each profile has its own "
        ...
        post_workspace_parts.append(
            ...
            f"and writes {get_sparkii_home()}/profiles/{active_profile}/. The default "
            f"profile's data lives at {get_sparkii_home()}/skills/, {get_sparkii_home()}/plugins/, "
            f"{get_sparkii_home()}/cron/, {get_sparkii_home()}/memories/ — those belong to a "
