...
# ``data:`` field before Sparkii receives a completion chunk.  Keeping this
...
#
# See: https://github.com/NousResearch/sparkii-agent/issues/27344
...
# case: a stream dies mid-response and Sparkii persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # sparkii_cli.plugins.VALID_HOOKS for the callback contract). Callback
