"""Core NeMo Relay adapter for Sparkii tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Sparkii tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Sparkii Relay tool execution cannot run on an active event-loop thread"
    )
