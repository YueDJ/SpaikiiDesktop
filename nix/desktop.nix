...
let
  ...
  targetPlatform =
    if stdenv.hostPlatform.isDarwin then
      ...
      throw "sparkii-desktop: unsupported host platform for node-pty staging";
  ...
  renderer = hermesNpmLib.buildNpmPackage {
    ...
    pname = "sparkii-desktop-renderer";
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    mkdir -p $out/share/sparkii-desktop $out/bin
    cp -r ${renderer}/* $out/share/sparkii-desktop/
    ...
    substituteInPlace $out/share/sparkii-desktop/dist/electron-main.mjs \
