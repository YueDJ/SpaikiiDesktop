      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SPARKII_BUNDLED_SKILLS /
            # SPARKII_OPTIONAL_SKILLS (see sparkii-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SPARKII_BUNDLED_LOCALES
            # / SPARKII_OPTIONAL_MCPS, not via the wheel. Excluding them
