# nix/overlays.nix — Expose pkgs.sparkii-agent for external NixOS configs
#
...
# `pkgs.sparkii-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    sparkii-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
