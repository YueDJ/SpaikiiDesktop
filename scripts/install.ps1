...
$RepoUrlSsh = "git@github.com:YueDJ/SparkiiDesktop.git"
$RepoUrlHttps = "https://github.com/YueDJ/SparkiiDesktop.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/YueDJ/SparkiiDesktop/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/YueDJ/SparkiiDesktop/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/YueDJ/SparkiiDesktop/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/YueDJ/SparkiiDesktop/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
