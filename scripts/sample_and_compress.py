...
DEFAULT_DATASETS = [
    ...
    "NousResearch/sparkii-agent-megascience-sft1",
    "NousResearch/Sparkii-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Sparkii-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-sparkii-agent"
]
