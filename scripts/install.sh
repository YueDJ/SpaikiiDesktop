...
# Configuration
REPO_URL_SSH="git@github.com:YueDJ/SpaikiiDesktop.git"
REPO_URL_HTTPS="https://github.com/YueDJ/SpaikiiDesktop.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/YueDJ/SpaikiiDesktop/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
