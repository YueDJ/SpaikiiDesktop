#!/usr/bin/env python3
"""Build the Sparkii Model Catalog — a centralized JSON manifest of curated models.
...
Sparkii CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Sparkii release.
...
# Ensure SPARKII_HOME is set for imports that touch it at module level.
os.environ.setdefault("SPARKII_HOME", os.path.join(os.path.expanduser("~"), ".sparkii"))

from sparkii_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "sparkii-agent repo",
            "docs": "https://sparkii-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Sparkii '
