#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Sparkii logs.
...
With no LOGFILE, reads ``$SPARKII_HOME/logs/agent.log`` (default ~/.sparkii).
...
def default_log() -> Path:
    home = os.environ.get("SPARKII_HOME") or str(Path.home() / ".sparkii")
