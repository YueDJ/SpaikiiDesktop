#!/usr/bin/env python3
"""Build the Sparkii Skills Index — a centralized JSON catalog of all skills.
...
`sparkii skills search/install` can use it without hitting the GitHub API.
...
# Ensure SPARKII_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Sparkii Skills Index...", flush=True)
