    ...
    def __init__(
        ...
        *,
        ...
        self._heartbeat_secs = (
            ...
            else float(os.environ.get("SPARKII_COMPUTE_HOST_HEARTBEAT_SECS") or "15")
        )
...
def _default_workers() -> int:
    try:
        return max(2, int(os.environ.get("SPARKII_TUI_RPC_POOL_WORKERS") or "8"))
    except (TypeError, ValueError):
        return 8


def run_host(stdin: Any = None, stdout: Any = None) -> None:
    os.environ["SPARKII_COMPUTE_HOST_CHILD"] = "1"
