...
def _default_registry_path() -> Path:
    return get_sparkii_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_sparkii_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_sparkii_home = expected_sparkii_home if expected_sparkii_home is not None else str(get_sparkii_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["SPARKII_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
