...
def resolve_profile(rid, params, err_fn) -> Tuple[Optional[Any], Optional[dict]]:
    """Resolve the optional ``profile`` param to a SPARKII_HOME override token.
    ...
    return set_sparkii_home_override(str(profile_dir)), None
...
def summarize_server(name: str, cfg: dict) -> Dict[str, Any]:
    ...
    """
    from sparkii_cli.mcp_config import _oauth_tokens_present
