# Streaming LLM Response Support for Sparkii Agent
...
```
SPARKII_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SPARKII_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `sparkii_cli/config.py` | 1 | +streaming config defaults |
...
SPARKII_STREAMING_ENABLED=true
```
