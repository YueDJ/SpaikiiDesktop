...
required — uses aiohttp which is already a Sparkii dependency.
...
def interactive_setup() -> None:
    ...
    ``sparkii_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Sparkii delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # sparkii_cli/setup.py::_setup_mattermost function.
