...
class LineAdapter(BasePlatformAdapter):
    ...
    async def _handle_media(self, request) -> Any:
        ...
        try:
            ...
            sparkii_home = Path.home().joinpath(".hermes").resolve()
...
def interactive_setup() -> None:
    ...
    one optional public URL. Writes to ``~/.hermes/.env`` via ``sparkii_cli.config``.
    """
    print()
    ...
    try:
        ...
        print("sparkii_cli.config not available; set LINE_* vars manually in ~/.hermes/.env")
        return
