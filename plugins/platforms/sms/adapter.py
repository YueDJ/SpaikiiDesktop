...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Sparkii gateway adapter.

    Each inbound phone number gets its own Sparkii session (multi-tenant).
...
# static dict in sparkii_cli/gateway.py, and the _send_sms dispatch in
