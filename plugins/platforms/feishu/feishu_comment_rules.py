...
Config: ~/.sparkii/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.sparkii/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_sparkii_home()`` helper (SPARKII_HOME-aware and
...
RULES_FILE = get_sparkii_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_sparkii_home() / "feishu_comment_pairing.json"
