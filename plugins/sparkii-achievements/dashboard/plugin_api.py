...
def state_path() -> Path:
    return get_sparkii_home() / "plugins" / "sparkii-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_sparkii_home() / "plugins" / "sparkii-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_sparkii_home() / "plugins" / "sparkii-achievements" / "scan_checkpoint.json"
