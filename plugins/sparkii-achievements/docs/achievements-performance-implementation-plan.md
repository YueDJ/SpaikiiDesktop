# Sparkii Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.sparkii/plugins/sparkii-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.sparkii/plugins/sparkii-achievements/scan_checkpoint.json`.
