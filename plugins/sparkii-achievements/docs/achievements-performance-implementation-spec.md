# Sparkii Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.sparkii/plugins/sparkii-achievements/state.json` (existing unlock state)
  - `~/.sparkii/plugins/sparkii-achievements/scan_snapshot.json` (new)
  - `~/.sparkii/plugins/sparkii-achievements/scan_checkpoint.json` (new)
