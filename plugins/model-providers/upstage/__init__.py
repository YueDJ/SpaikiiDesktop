...
# When the user hasn't picked a reasoning effort, Sparkii passes
...
# ON at this effort — matching the "medium (default)" that Sparkii' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Sparkii' effort vocabulary onto Solar's accepted set. xhigh/max/
