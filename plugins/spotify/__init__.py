...
``_check_spotify_available()`` — when the user has not run ``sparkii auth
spotify``, the tools remain registered (so they appear in ``sparkii
...
The Spotify auth flow (``sparkii auth spotify``), CLI plumbing, and docs
