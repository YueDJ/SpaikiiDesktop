"""CLI-facing shim for :mod:`core.tools_config`.
...
imports and tests keep working; new code should import from ``core.tools_config``
directly.
"""

from __future__ import annotations

import core.tools_config as _core_mod
