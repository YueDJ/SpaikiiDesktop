"""CLI-facing shim for :mod:`core.memory_setup`.
...
imports and tests keep working; new code should import from ``core.memory_setup``
directly.
"""

from __future__ import annotations

import core.memory_setup as _core_mod
