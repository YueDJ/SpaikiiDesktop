"""CLI-facing shim for :mod:`core.model_normalize`.
...
imports and tests keep working; new code should import from ``core.model_normalize``
directly.
"""

from __future__ import annotations

import core.model_normalize as _core_mod
