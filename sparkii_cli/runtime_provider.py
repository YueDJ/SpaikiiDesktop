"""CLI-facing shim for :mod:`core.runtime_provider`.
...
imports and tests keep working; new code should import from ``core.runtime_provider``
directly.
"""

from __future__ import annotations

import core.runtime_provider as _core_mod
