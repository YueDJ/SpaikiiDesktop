...
def build_models_payload(
    ...
    *,
    ...
    try:
        from sparkii_cli.providers import is_routing_aggregator as _is_routing_aggregator
    except Exception:
...
def _apply_custom_aliases(rows: list[dict]) -> None:
    ...
    """
    from sparkii_cli.providers import custom_provider_aliases
...
def _append_unconfigured_rows(
    ...
    *,
    ...
    from sparkii_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
