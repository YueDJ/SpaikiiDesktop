...
Entry point: ``sparkii whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``sparkii_cli/main.py``).
...
Sparkii gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Sparkii to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Sparkii needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Sparkii gateway in another terminal:")
    print("         sparkii gateway")
    print()
    ...
    print()
    print("  Docs: https://sparkii-agent.nousresearch.com/docs/user-guide/")
