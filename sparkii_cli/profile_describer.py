"""CLI-facing shim for :mod:`core.profile_describer`.
...
imports and tests keep working; new code should import from ``core.profile_describer``
directly.
"""

from __future__ import annotations

import core.profile_describer as _core_mod
