...
TIPS = [
    ...
    "sparkii mcp serve runs Hermes itself as an MCP server for other agents.",
    ...
    "sparkii backup creates a zip backup of your entire Hermes home directory.",
    ...
    "sparkii gateway install sets up Hermes as a system service (systemd/launchd).",
    ...
    "Hermes loads project context from .sparkii.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "sparkii acp runs Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "Profiles scope Hermes state via SPARKII_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'sparkii dashboard embeds the full Hermes TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'sparkii import restores a full Hermes backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
