"""CLI-facing shim for :mod:`core.copilot_auth`.
...
imports and tests keep working; new code should import from ``core.copilot_auth``
directly.
"""

from __future__ import annotations

import core.copilot_auth as _core_mod
