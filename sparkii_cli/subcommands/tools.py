"""``sparkii tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'sparkii tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # sparkii tools list [--platform cli]
    ...
    # sparkii tools disable <name...> [--platform cli]
    ...
    # sparkii tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `sparkii tools` runs after you pick a provider that\n"
