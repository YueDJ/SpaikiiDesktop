...
This module deliberately has no module-level imports from ``sparkii_cli.config``
...
def resolve_ephemeral_system_prompt(cfg: Optional[Dict[str, Any]]) -> str:
    ...
    prefer ``SPARKII_EPHEMERAL_SYSTEM_PROMPT`` when that env var is set.
    """
...
def persist_personality(value: Any) -> bool:
    ...
    SPARKII_HOME config.yaml atomically, preserving comments and ordering.
