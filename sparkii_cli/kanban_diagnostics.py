"""CLI-facing shim for :mod:`core.kanban_diagnostics`.
...
imports and tests keep working; new code should import from ``core.kanban_diagnostics``
directly.
"""

from __future__ import annotations

import core.kanban_diagnostics as _core_mod
