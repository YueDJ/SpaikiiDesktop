"""CLI-facing shim for :mod:`core.projects_db`.
...
imports and tests keep working; new code should import from ``core.projects_db``
directly.
"""

from __future__ import annotations

import core.projects_db as _core_mod
