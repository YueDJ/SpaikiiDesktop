...
_DEP_CHECKS = {
    # find_node_executable() rather than a bare which(): $SPARKII_HOME/node is
...
def _has_sparkii_agent_browser() -> bool:
    ...
    # install.sh installs globally into $SPARKII_HOME/node/bin/ via npm -g --prefix
