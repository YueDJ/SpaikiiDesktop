...
- sparkii gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `sparkii setup` on a fresh Pi.
    ...
    sparkii_cli/stdio.py::configure_windows_stdio() runs later from the entry
