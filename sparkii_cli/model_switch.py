...
def _ensure_direct_aliases() -> None:
    ...
    the module attribute. This keeps `from sparkii_cli.model_switch import
...
def switch_model(
    ...
    if provider_changed or explicit_provider:
        ...
        if explicit_provider and user_providers:
            from sparkii_cli.providers import resolve_user_provider as _ruser
        ...
        if current_provider == "custom" and current_base_url:
            try:
                from sparkii_cli.models import should_use_ollama_native_catalog
...
def _prefetch_provider_models_parallel(provider_slugs: list[str]) -> None:
    ...
    """
    from sparkii_cli.models import cached_provider_model_ids
    ...
    def _fetch_one(slug: str) -> None:
        try:
            ...
            if models:
                from sparkii_cli.models import update_provider_cache_entry
...
def _collect_authed_provider_slugs(
    ...
    from sparkii_cli.auth import PROVIDER_REGISTRY, _load_auth_store
    from sparkii_cli.providers import SPARKII_OVERLAYS, ALIASES as _PROVIDER_ALIAS_TABLE
    from sparkii_cli.models import _AGGREGATOR_PROVIDERS as _AGG_PROVIDERS, CANONICAL_PROVIDERS
...
def list_authenticated_providers(
    ...
    *,
    ...
    def _record_builtin_endpoint(slug: str) -> None:
        ...
        try:
            from sparkii_cli.auth import PROVIDER_REGISTRY as _reg
        except Exception:
            return
        pcfg = _reg.get(slug)
        if not pcfg:
    ...
    if "ollama-cloud" not in curated:
        from sparkii_cli.models import fetch_ollama_cloud_models
    ...
    if "lmstudio" not in curated and (
        ...
        from sparkii_cli.models import fetch_lmstudio_models
    ...
    for pid, overlay in SPARKII_OVERLAYS.items():
        ...
        # reflects the active region (eu.*, ap.*) not the static us.* list.
            ...
            try:
                ...
                from sparkii_cli.auth import get_provider_auth_state as _nous_state
    ...
    # with `sparkii model`).
    try:
        from sparkii_cli.models import CANONICAL_PROVIDERS as _canon_provs
    except ImportError:
        _canon_provs = []
...
def _prepend_moa_picker_provider(providers: List[dict], current_provider: str = "") -> List[dict]:
    ...
    """
    try:
        from sparkii_cli.inventory import _moa_provider_row
...
def list_picker_providers(
    ...
    """
    from sparkii_cli.models import fetch_openrouter_models
