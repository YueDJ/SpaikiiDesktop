"""CLI-facing shim for :mod:`core.model_switch`.
...
imports and tests keep working; new code should import from ``core.model_switch``
directly.
"""

from __future__ import annotations

import core.model_switch as _core_mod
