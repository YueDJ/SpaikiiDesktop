"""CLI-facing shim for :mod:`core.kanban_specify`.
...
imports and tests keep working; new code should import from ``core.kanban_specify``
directly.
"""

from __future__ import annotations

import core.kanban_specify as _core_mod
