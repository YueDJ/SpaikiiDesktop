"""CLI-facing shim for :mod:`core.resource_limits`.
...
imports and tests keep working; new code should import from ``core.resource_limits``
directly.
"""

from __future__ import annotations

import core.resource_limits as _core_mod
