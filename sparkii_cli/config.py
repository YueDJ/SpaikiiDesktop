...
from sparkii_cli.default_soul import DEFAULT_SOUL_MD, is_legacy_template_soul
...
from sparkii_cli.config_defaults import DEFAULT_CONFIG, OPTIONAL_ENV_VARS  # noqa: F401
...
def migrate_config(interactive: bool = True, quiet: bool = False) -> Dict[str, Any]:
    ...
    if floor_refused:
        ...
        # The per-version steps live in sparkii_cli.config_migrations as a
...
def show_config():
    ...
    from sparkii_cli.auth import get_anthropic_key
