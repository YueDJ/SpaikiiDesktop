"""CLI-facing shim for :mod:`core.approval_transport`.
...
imports and tests keep working; new code should import from ``core.approval_transport``
directly.
"""

from __future__ import annotations

import core.approval_transport as _core_mod
