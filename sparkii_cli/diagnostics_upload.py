"""Client for uploading ``sparkii debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``sparkii debug share``.
...
NAS_BASE = os.environ.get(
    "SPARKII_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "sparkii-agent/debug-share"
