"""CLI-facing shim for :mod:`core.kanban_decompose`.
...
imports and tests keep working; new code should import from ``core.kanban_decompose``
directly.
"""

from __future__ import annotations

import core.kanban_decompose as _core_mod
