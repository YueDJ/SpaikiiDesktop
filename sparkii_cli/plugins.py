...
class PluginContext:
    ...
    def platform_actions(self):
        ...
        if self._platform_actions is None:
            from sparkii_cli.platform_actions import PlatformActions
    ...
    def register_dashboard_auth_provider(self, provider) -> Optional[PluginRegistration]:
        ...
        from sparkii_cli.dashboard_auth.registry import restore_registration
        from sparkii_cli.dashboard_auth.registry import snapshot_registration
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        # Lazy import to avoid circular: sparkii_cli.main imports plugins indirectly
        from sparkii_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
...
class PluginManager:
    ...
    def register_approval_transport(
        ...
        *,
        ...
        from sparkii_cli.approval_transport import RegisteredApprovalTransport
    ...
    def has_enabled_portable_mcp(self, raw_config: Mapping[str, Any]) -> bool:
        ...
        for manifest in winners.values():
            ...
            if lookup_key not in enabled and manifest.name not in enabled:
                continue
            try:
                from sparkii_cli.agent_plugins import _discover_mcp
        ...
        *,
        ...
        for child in sorted(path.iterdir()):
            ...
            if portable_file.exists() or portable_file.is_symlink():
                try:
                    from sparkii_cli.agent_plugins import read_agent_plugin_manifest
    ...
    def _load_portable_plugin(
        ...
        lookup_key = manifest.key or manifest.name
        try:
            from sparkii_cli.agent_plugins import load_agent_plugin
...
def _get_pre_tool_call_directive_details(
    ...
    from sparkii_cli.lifecycle import invoke_hook as invoke_lifecycle_hook
