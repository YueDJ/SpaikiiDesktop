"""CLI-facing shim for :mod:`core.model_catalog`.
...
imports and tests keep working; new code should import from ``core.model_catalog``
directly.
"""

from __future__ import annotations

import core.model_catalog as _core_mod
