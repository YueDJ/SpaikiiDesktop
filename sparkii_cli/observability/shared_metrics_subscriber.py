"""Relay subscriber for the persisted Sparkii shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Sparkii counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Sparkii shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
