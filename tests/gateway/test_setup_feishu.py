"""Tests for _setup_feishu() in sparkii_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("sparkii_cli.config.save_env_value", side_effect=mock_save), \
         patch("sparkii_cli.config.get_env_value", side_effect=mock_get), \
         patch("sparkii_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("sparkii_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("sparkii_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("sparkii_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("sparkii_cli.cli_output.print_header"), \
         patch("sparkii_cli.cli_output.print_info"), \
         patch("sparkii_cli.cli_output.print_success"), \
         patch("sparkii_cli.cli_output.print_warning"), \
         patch("sparkii_cli.cli_output.print_error"), \
