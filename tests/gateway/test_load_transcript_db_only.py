...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.sparkii/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at sparkii_state import time, before pytest's SPARKII_HOME monkeypatch
    fires — the autouse fixture's SPARKII_HOME override doesn't help here.)
    """
