...
REJECT = [
    ...
    "python -m sparkii_cli.main gateway status",           # other subcommand
    "python -m sparkii_cli.main gateway restart",
    "python -m sparkii_cli.main gateway stop",
    "python -m sparkii_cli.main --profile x dashboard",    # non-gateway subcommand
