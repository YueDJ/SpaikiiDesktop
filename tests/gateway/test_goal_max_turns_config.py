...
async def test_goal_command_slow_db_init_still_persists(tmp_path, monkeypatch):
    ...
    tests/sparkii_cli/test_goals_db_bootstrap_off_loop.py; no wall-clock
    ...
    real_session_db = sparkii_state.SessionDB
    ...
    monkeypatch.setattr(sparkii_state, "SessionDB", _SlowSessionDB)
