...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("SPARKII_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("SPARKII_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("SPARKII_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
