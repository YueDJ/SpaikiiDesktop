...
from sparkii_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/sparkii_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("sparkii_cli.lifecycle.invoke_hook")
@patch("sparkii_cli.lifecycle.finalize_session")
