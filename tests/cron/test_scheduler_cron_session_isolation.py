...
def test_run_job_cron_execute_code_deny_does_not_pollute_later_gateway_execute_code(
    ...
    monkeypatch.setenv("SPARKII_MODEL", "test-model")
    monkeypatch.setattr(approval_module, "_YOLO_MODE_FROZEN", False)
    monkeypatch.setattr(approval_module, "_get_approval_mode", lambda: "manual")
    monkeypatch.setattr(approval_module, "_get_cron_approval_mode", lambda: "deny")
    monkeypatch.setattr("sparkii_state.SessionDB", _DummySessionDB)
    ...
    monkeypatch.setattr(cron_scheduler, "_get_sparkii_home", lambda: tmp_path)
    ...
    assert os.environ.get("SPARKII_CRON_SESSION") is None
    ...
    assert get_session_env("SPARKII_CRON_SESSION") == "1"
    monkeypatch.delenv("SPARKII_CRON_SESSION")
