...
def worker_loop(worker_id: int, sparkii_home: str, result_file: str) -> None:
...
def reclaimer_loop(sparkii_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="sparkii_mixed_stress_")
    print(f"SPARKII_HOME = {home}")
