"""Tests for the interactive session browser (`sparkii sessions browse`).
...
from sparkii_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """sparkii sessions browse should be parseable."""
