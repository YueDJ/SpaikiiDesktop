...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("SPARKII_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test SPARKII_HOME."""
    monkeypatch.setenv("SPARKII_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # SPARKII_HOME patch the client/profile_dir fixtures installed.
