"""Tests for `sparkii chat --safe-mode` isolation."""
...
_VARS = ("SPARKII_SAFE_MODE", "SPARKII_IGNORE_USER_CONFIG", "SPARKII_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SPARKII_SAFE_MODE"] == "1"
        assert os.environ["SPARKII_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SPARKII_IGNORE_RULES"] == "1"
        return True
