...
Sparkii state stays profile-scoped through SPARKII_HOME. Host subprocesses should
...
See: https://github.com/YueDJ/SpaikiiDesktop/issues/25114
See: https://github.com/YueDJ/SpaikiiDesktop/issues/36144
See: https://github.com/YueDJ/SpaikiiDesktop/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def test_real_mode_repairs_parent_home_already_pointing_at_profile(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("SPARKII_REAL_HOME", str(real_home))

        from sparkii_constants import get_subprocess_home, get_real_home
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        self._container_mode(monkeypatch)
        base = tmp_path / ".sparkii" / "profiles"
        ...
        monkeypatch.setenv("SPARKII_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("SPARKII_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_no_injection_when_sparkii_home_unset(self, monkeypatch):
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from sparkii_cli.profiles import _PROFILE_DIRS
