...
from sparkii_cli.account_usage import (
...
def test_fetch_account_usage_codex(monkeypatch):
    monkeypatch.setattr(
        "sparkii_cli.account_usage.resolve_codex_runtime_credentials",
    ...
    monkeypatch.setattr(
        "sparkii_cli.account_usage._read_codex_tokens",
        lambda: {"tokens": {"account_id": "acct_123"}},
    )
    monkeypatch.setattr(
        "sparkii_cli.account_usage.httpx.Client",
...
def test_fetch_account_usage_openrouter_uses_limit_remaining_and_ignores_deprecated_rate_limit(monkeypatch):
    monkeypatch.setattr(
        "sparkii_cli.account_usage.resolve_runtime_provider",
