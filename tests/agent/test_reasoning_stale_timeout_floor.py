...
thinking phase.  Sparkii's default cloud-stream stale detector
(``SPARKII_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SPARKII_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
