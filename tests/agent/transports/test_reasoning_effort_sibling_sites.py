...
class TestKimiEffortVocabulary:
    def test_k3_maps_full_sparkii_ladder(self):
        expected = {
            "minimal": "low",
            "low": "low",
            "medium": "high",
        ...
        for sparkii_level, wire_level in expected.items():
            kw = _kimi_kwargs(
                "kimi-k3", {"enabled": True, "effort": sparkii_level}
            )
            assert kw["reasoning_effort"] == wire_level, sparkii_level
