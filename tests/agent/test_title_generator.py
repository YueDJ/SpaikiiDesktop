...
class TestGenerateTitle:
    ...
    def test_title_language_reads_config(self):
        ...
        with patch("core.config.load_config", return_value={}), patch("core.config.load_config_readonly", return_value={}):
            assert _title_language() == ""
        with patch("core.config.load_config", side_effect=RuntimeError("bad config")), \
         patch("core.config.load_config_readonly", side_effect=RuntimeError("bad config")):
            assert _title_language() == ""
