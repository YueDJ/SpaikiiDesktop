...
ContextVar resolves to the child id (get_session_env / SPARKII_SESSION_ID).
"""
...
def test_f5_session_contextvar_rebound_after_rotation(
    ...
    try:
        assert get_session_env("SPARKII_SESSION_ID") == parent_sid
        ...
        assert get_session_env("SPARKII_SESSION_ID") == agent.session_id, (
