"""Session <-> workspace grouping key (sparkii_state.workspace_key).

The key is what `sparkii sessions list --workspace` groups/filters on. It is a
...
from sparkii_state import workspace_key
