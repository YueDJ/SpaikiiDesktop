...
the *mutation* side: `sparkii plugins enable/disable` must resolve a bare name
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `sparkii plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from sparkii_cli.plugins_cmd import _run_composite_fallback
