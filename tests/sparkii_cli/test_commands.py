...
class TestSlackAppManifest:
    """Generated Slack app manifest (used by `sparkii slack manifest`)."""
...
from sparkii_cli.commands import discord_skill_commands_by_category  # noqa: E402
