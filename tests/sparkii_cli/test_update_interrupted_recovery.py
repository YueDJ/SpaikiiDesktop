...
def _stub_install_env(monkeypatch, m, seen):
    ...
    monkeypatch.setattr("core.managed_uv.ensure_uv", lambda: None)
    # The install executor moved to sparkii_cli._install_repair (shared between
    ...
    import sparkii_cli._install_repair as ir
