...
check: npm states the range it wants in the failure, Sparkii upgrades only an
...
class TestManagedDetection:
    ...
    no other npm — this is the boundary between "Sparkii fixes it" and "the
...
class TestRepairDecision:
    ...
    def test_foreign_npm_provisions_managed_runtime_instead(
        ...
        """A system/nvm/brew/Nix npm is never modified — Sparkii provisions its
