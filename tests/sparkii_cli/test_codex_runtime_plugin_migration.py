...
class TestMigrate:
    ...
    def test_plugin_discovery_writes_plugin_blocks(self, tmp_path, monkeypatch):
        ...
        from sparkii_cli import codex_runtime_plugin_migration as crpm
    ...
    def test_preserves_user_mcp_server_outside_managed_block(self, tmp_path):
        ...
        to ~/.codex/config.toml outside Sparkii' managed block, re-running
...
class TestSparkiiHomeLeakGuard:
