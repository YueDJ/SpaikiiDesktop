"""Tests for the Command Installation check in sparkii doctor."""
...
import sparkii_cli.doctor as doctor_mod


def _setup_doctor_env(monkeypatch, tmp_path, venv_name="venv"):
    """Create a minimal SPARKII_HOME + PROJECT_ROOT for doctor tests."""
