"""Tests for `sparkii secrets bitwarden token` / `sparkii secrets onepassword token`.
...
from sparkii_cli import onepassword_secrets_cli as op_cli
from sparkii_cli import secrets_cli as bw_cli
