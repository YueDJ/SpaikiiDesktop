...
from sparkii_cli.runtime_provider import _resolve_named_custom_runtime
...
def test_resolve_named_custom_runtime_honors_explicit_base_url(monkeypatch):
    ...
    monkeypatch.setattr("sparkii_cli.runtime_provider.has_usable_secret", lambda x: x == "test-api-key")
