"""Tests for MCP tools interactive configuration in core.tools_config."""

from unittest.mock import patch

from core.tools_config import _configure_mcp_tools_interactive
...
_SAVE = "core.tools_config.save_config"
