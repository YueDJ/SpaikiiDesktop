"""Tests for ``sparkii approvals suggest`` (sparkii_cli/approvals_suggest.py).

Approval history in Sparkii is implied, not ledgered: the session DB
...
from sparkii_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
