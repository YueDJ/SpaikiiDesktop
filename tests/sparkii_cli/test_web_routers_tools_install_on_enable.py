...
the endpoint spawns the same background ``sparkii tools post-setup <key>``
...
class TestToggleToolsetInstallOnEnable:
    ...
    def _spawn_recorder(self, monkeypatch):
        ...
        monkeypatch.setattr(web_server, "_spawn_sparkii_action", _fake_spawn)
        return calls
    ...
    def test_spawn_failure_does_not_fail_the_toggle(self, monkeypatch):
        ...
        monkeypatch.setattr(web_server, "_spawn_sparkii_action", _boom)
