"""Tests for the specifier module + `sparkii kanban specify` CLI surface.
...
from sparkii_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `sparkii kanban …` argparse surface directly."""
