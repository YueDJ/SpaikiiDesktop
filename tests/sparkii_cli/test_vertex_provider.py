...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (sparkii_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_sparkii_overlays():
    """sparkii_cli.providers.get_provider("vertex") backs
