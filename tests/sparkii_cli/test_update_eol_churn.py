"""Regression: ``sparkii update`` should take a managed checkout off autocrlf=true.
...
``sparkii update`` has to repair them.
...
from sparkii_cli.update_cmd import _normalize_managed_eol
