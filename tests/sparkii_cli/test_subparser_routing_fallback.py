...
The main() function in sparkii_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `sparkii -c model`
...
def _build_parser():
    """Build a minimal replica of the sparkii top-level parser."""
