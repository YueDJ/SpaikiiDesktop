"""Tests for sparkii tools disable/enable/list command (backend)."""
...
from core.tools_config import tools_disable_enable_command
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("core.tools_config.load_config", return_value=config), \
             patch("core.tools_config.save_config") as mock_save:
    ...
    try:
        with patch(
            ...
            side_effect=discover_deferred_platform,
             ...
             patch("core.tools_config.load_config", return_value=config), \
             patch("core.tools_config.save_config") as save:
