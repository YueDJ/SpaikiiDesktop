...
Bug class: the checkout's ``.py`` files change (``sparkii update``, manual
...
def _make_pycache(repo: Path, subdir: str = "sparkii_cli") -> Path:
...
# ---------------------------------------------------------------------------
# Plugin-update sibling site: __pycache__ under ~/.sparkii/plugins/<name>
# ---------------------------------------------------------------------------
