...
class TestLocalOllamaModelDiscovery:
    ...
    def test_native_tags_cache_expires(self, monkeypatch):
        from sparkii_cli.models import fetch_ollama_local_models
        ...
        try:
            ...
            monkeypatch.setattr("sparkii_cli.models.time.monotonic", lambda: 301.0)
    ...
    def test_runtime_error_from_config_load_does_not_escape_ollama_helpers(self):
        ...
        from sparkii_cli.models import _get_ollama_base_url, should_use_ollama_native_catalog

        with patch("sparkii_cli.config.load_config", side_effect=RuntimeError("bad home")), patch(
            "sparkii_cli.models.probe_ollama_local_models",
            return_value=None,
        ):
    ...
    def test_probe_ollama_models_malformed_base_url_returns_none(self):
        ...
        from sparkii_cli.models import probe_ollama_local_models
    ...
    def test_fetch_ollama_models_preserves_probe_failure(self):
        ...
        with patch("sparkii_cli.models.probe_ollama_local_models", return_value=None):
    ...
    def test_ollama_port_detection_requires_working_api_tags(self):
        ...
        with patch("sparkii_cli.models.probe_ollama_local_models", return_value=["qwen3:1.7b"]):
    ...
    def test_provider_model_ids_ollama_cloud_config_uses_generic_catalog(self):
        ...
        ), patch("sparkii_cli.models.fetch_ollama_local_models") as fetch_local, patch(
    ...
    def test_native_ollama_catalog_uses_configured_key_env(self, monkeypatch):
        from sparkii_cli.models import _get_ollama_request_headers
    ...
    def test_ollama_cache_fingerprint_does_not_probe_custom_endpoint(self):
        from sparkii_cli.models import _credential_fingerprint
        ...
        ), patch("sparkii_cli.models.probe_ollama_local_models") as probe_ollama:
    ...
    def test_picker_user_provider_verifies_ambiguous_ollama_port(self):
        ...
        with patch("sparkii_cli.config.load_config", return_value={"providers": {}}), patch(
            "sparkii_cli.models.should_use_ollama_native_catalog",
            return_value=True,
        ), patch(
            "sparkii_cli.models.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
        ), patch("sparkii_cli.models.fetch_api_models", return_value=[]) as fetch_api:
            rows = list_authenticated_providers(
    ...
    def test_named_custom_model_flow_discovers_ollama_api_tags(self):
        ...
        try:
            with patch("sparkii_cli.config.load_config", return_value=config), patch(
                "sparkii_cli.config.save_config"
    ...
    def test_model_validation_ollama_cloud_config_does_not_use_local_tags(self):
        ...
        ), patch("sparkii_cli.models.probe_ollama_local_models") as probe_ollama, patch(
    ...
    def test_switch_model_on_current_ollama_custom_endpoint_keeps_base_url(self):
        ...
        try:
            with patch(
                ...
                "sparkii_cli.model_switch.get_model_info",
                return_value=None,
            ):
                result = switch_model(
    ...
    def test_ollama_root_matching_is_case_insensitive_for_hostnames(self):
        from sparkii_cli.models import _same_ollama_native_root
    ...
    def test_ollama_host_environment_forms_are_normalized(self, monkeypatch):
        from sparkii_cli.models import _get_ollama_base_url, _root_for_ollama_native_api
    ...
    def test_switch_model_direct_ollama_alias_preserves_matching_origin_api_key(self):
        import sparkii_cli.model_switch as model_switch
