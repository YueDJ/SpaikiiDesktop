...
class TestParseIntervalToken:
    def test_minutes(self):
        from core.loops import parse_interval_token
...
class TestParseLoopArgs:
    def test_fixed_interval(self):
        from core.loops import parse_loop_args
...
class TestFormatInterval:
    def test_render(self):
        from core.loops import format_interval
...
class TestResponseSignalsComplete:
    def test_marker_on_own_line(self):
        from core.loops import response_signals_complete
...
class TestLoopStateSerde:
    def test_round_trip(self):
        from core.loops import LoopState
...
class TestPersistence:
    def test_save_load_clear(self, sparkii_home):
        from core.loops import LoopManager, load_loop
    ...
    def test_list_active_loops(self, sparkii_home):
        from core.loops import LoopManager, list_active_loops
    ...
    def test_migrate_to_session(self, sparkii_home):
        from core.loops import LoopManager, load_loop, migrate_loop_to_session
...
class TestTickLifecycle:
    ...
    def test_until_judge_done_stops(self, sparkii_home):
        ...
        state.next_due_at = time.time() - 1
        mgr.fire_tick()
        with patch("core.goals.judge_goal", return_value=("done", "suite green", False, None, False)):
    ...
    def test_until_judge_continue_loops(self, sparkii_home):
        ...
        state.next_due_at = time.time() - 1
        mgr.fire_tick()
        with patch("core.goals.judge_goal", return_value=("continue", "3 failures", False, None, False)):
    ...
    def test_until_judge_error_fails_open(self, sparkii_home):
        ...
        state.next_due_at = time.time() - 1
        mgr.fire_tick()
        with patch("core.goals.judge_goal", side_effect=RuntimeError("api down")):
...
class TestControls:
    def test_min_interval_enforced(self, sparkii_home):
        from core.loops import LoopManager, min_interval_seconds
...
class TestGoalMixing:
    def test_active_goal_blocks_tick(self, sparkii_home):
        ...
        from core.loops import goal_blocks_loop_tick
...
class TestDispatchLoopCommand:
    def test_create_fixed(self, sparkii_home):
        from core.loops import LoopManager, dispatch_loop_command
    ...
    def test_route_stored(self, sparkii_home):
        from core.loops import LoopManager, dispatch_loop_command, load_loop
