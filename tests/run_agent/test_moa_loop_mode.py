...
def test_reference_messages_drops_system_but_renders_tools_as_text():
    ...
    messages = [
        {"role": "system", "content": "huge sparkii system prompt"},
    ...
    assert all("huge sparkii system prompt" not in m["content"] for m in view)
...
def test_reference_messages_flattens_cache_decorated_content():
    ...
    plain = [
        {"role": "system", "content": "sparkii system prompt"},
        {"role": "user", "content": "Can we get codex usage resets into sparkii?"},
    ]
