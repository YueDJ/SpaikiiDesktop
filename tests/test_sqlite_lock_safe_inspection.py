"""POSIX advisory locks must survive Sparkii' own database inspection.
...
Sparkii used to byte-probe live databases in several places (kanban's
...
out across Sparkii' inspection calls.
"""
...
def test_probe_and_connect_do_not_race(tmp_path, clean_registry, monkeypatch):
    ...
    """
    import sparkii_cli.sqlite_safe_read as ssr
