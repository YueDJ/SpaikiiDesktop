...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/sparkii config files without modify intent.
        ...
        assert _scan_memory_content("Read .sparkii/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .sparkii/config.yaml for settings") is None
        # 'send' without a URL.
