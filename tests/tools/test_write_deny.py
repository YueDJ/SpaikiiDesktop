...
class TestWriteDenyExactPaths:
    ...
    def test_sparkii_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.sparkii/.env`` (whose credentials are inherited by every profile)
...
class TestWriteAllowed:
    ...
    def test_sparkii_control_files_requested_writable(self):
