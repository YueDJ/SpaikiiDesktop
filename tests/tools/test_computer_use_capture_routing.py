...
* ``sparkii_constants.get_sparkii_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_sparkii_dir so cache writes land under tmp_path."""
    ...
    with patch("sparkii_constants.get_sparkii_dir", _fake_get):
        yield cache_dir
