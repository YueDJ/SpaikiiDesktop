...
def ledger_env(tmp_path, monkeypatch):
    """Isolated SPARKII_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_sparkii_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_sparkii_home", lambda: home)
...
def test_rollback_refuses_paths_outside_sparkii_home(ledger_env):
    """A hand-edited ledger entry pointing outside SPARKII_HOME must not
