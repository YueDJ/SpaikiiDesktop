...
The unit tests in tests/sparkii_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned sparkii-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/sparkii")
from sparkii_cli.service_manager import S6ServiceManager
