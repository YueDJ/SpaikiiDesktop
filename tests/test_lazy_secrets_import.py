"""Regression test: sparkii update must not load cryptography eagerly."""
...
assert 'sparkii_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running sparkii update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so sparkii_cli is importable,
...
import sparkii_cli.main
from sparkii_cli.update_cmd import _cmd_update_check
