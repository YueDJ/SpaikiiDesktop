...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and sparkii-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # sparkii-agent (tests/skills/)
]
