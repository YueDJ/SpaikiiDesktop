"""The `sparkii-agent` skill is what a running Sparkii knows about itself.

`website/` is never packaged, so an installed Sparkii has no local copy of the
user guide; skills ARE synced into `$SPARKII_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Sparkii can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "sparkii-agent"
