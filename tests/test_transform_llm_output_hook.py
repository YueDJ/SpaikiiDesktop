...
def _make_enabled_plugin(sparkii_home: Path, name: str, register_body: str) -> Path:
    """Create a plugin under <sparkii_home>/plugins/<name> and opt it in."""
    plugin_dir = sparkii_home / "plugins" / name
...
def test_no_plugins_returns_empty_results(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("SPARKII_HOME", str(tmp_path / "sparkii_empty"))
