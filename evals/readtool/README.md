...
benchmarked ten harnesses on hostile-file handling — and whose Sparkii column
...
Every task runs the full Sparkii agent (file + terminal + search toolsets)
...
Rules of engagement (from ___SPARKIIBENCH_URL_PRESERVE___ discipline):
