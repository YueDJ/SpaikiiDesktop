...
The A/B battery behind PR [#81958](https://github.com/NousResearch/sparkii-agent/pull/81958)
...
- **Arms differ only by tree + config.** `base` runs the built-in twelve
  ...
  digest's value). Each cell gets a throwaway `SPARKII_HOME`; web-fetch
