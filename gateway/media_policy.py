...
from environment variables:
  ...
  - ``SPARKII_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``SPARKII_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``SPARKII_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``sparkii cron run`` in the CLI, ``sparkii send``, a
...
_STRICT_ENV = "SPARKII_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "SPARKII_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "SPARKII_MEDIA_TRUST_RECENT_FILES"
