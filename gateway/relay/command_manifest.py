...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Sparkii session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Sparkii session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Sparkii agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Sparkii Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Sparkii gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Sparkii session in it",
