...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SPARKII_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_sparkii_dir("platforms/whatsapp/session", "whatsapp/session")
