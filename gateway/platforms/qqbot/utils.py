...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; Sparkii/<hermes_version>)
    ...
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; Sparkii/{hermes_version})"
