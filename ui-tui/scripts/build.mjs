...
await build({
  ...
  // Skip the prebuilt @sparkii/ink bundle and inline the source instead:
  ...
  alias: { '@sparkii/ink': resolve(root, 'packages/sparkii-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The sparkii_cli launcher
