 ...
 * across theme x background scenes to <tmpdir>/sparkii-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@sparkii/ink'
...
// The regenerated slate light_colors block from sparkii_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/sparkii-agent',
...
const setup = (bgHex: string) => {
  process.env.SPARKII_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
