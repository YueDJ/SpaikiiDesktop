...
import type { ScrollBoxHandle } from '@sparkii/ink'
import { evictInkCaches } from '@sparkii/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SPARKII_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
