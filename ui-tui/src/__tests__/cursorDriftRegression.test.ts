 ...
 *
 * Symptom: in `sparkii --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@sparkii/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using sparkii --tui and as i type multiline my caret at the end will often ' +
