import { Box, type ScrollBoxHandle, stringWidth, Text } from '@sparkii/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SPARKII_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SPARKII_DEV_CREDITS), lowest priority,
