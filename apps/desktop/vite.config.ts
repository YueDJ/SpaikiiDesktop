...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\sparkii\sparkii-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@sparkii/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@sparkii/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@sparkii/shared': path.resolve(__dirname, '../shared/src'),
