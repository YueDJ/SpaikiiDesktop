...
cd apps/desktop
XCURSOR_SIZE=24 SPARKII_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/sparkii-typing
# → /tmp/sparkii-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/sparkii-typing.before.heapsnapshot
# → /tmp/sparkii-typing.after.heapsnapshot
```
