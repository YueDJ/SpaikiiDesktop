...
import type { ModelOptionsResponse, SessionInfo } from '@/types/sparkii'
 ...
 *
 * Only the leading status prefix (e.g. "Sparkii is thinking...") and the
 ...
 *  resolved comment as JSON (SparkiiPrComment shape); a malformed payload falls
