...
//
// When someone is in a hands-free "Hey Sparkii" voice chat, the natural way to
...
// phrase (optionally addressed to Sparkii), so a real turn that merely contains
 ...
 * to Sparkii). Returns false for anything that merely contains "stop" as part of
