...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/sparkii-agent')).toBe('~/www/sparkii-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/sparkii-agent')).toBe('sparkii-agent')
    expect(pathLeaf('~/www/sparkii-agent')).toBe('sparkii-agent')
