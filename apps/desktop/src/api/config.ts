...
import { capabilityScoped, sparkiiApi, type ProfileScope, profileScoped, STARTUP_REQUEST_TIMEOUT_MS } from './client'

export function getStatus(): Promise<StatusResponse> {
  return sparkiiApi<StatusResponse>({
    ...profileScoped(),
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return sparkiiApi<LogsResponse>({
    ...profileScoped(),
...
export function getSparkiiConfig(profile?: string): Promise<SparkiiConfig> {
  return sparkiiApi<SparkiiConfig>({
...
export function getSparkiiConfigRecord(profile?: ProfileScope): Promise<SparkiiConfigRecord> {
...
export function getSparkiiConfigDefaults(): Promise<SparkiiConfigRecord> {
  return sparkiiApi<SparkiiConfigRecord>({
    ...profileScoped(),
...
export function getSparkiiConfigSchema(profile?: null | string): Promise<ConfigSchemaResponse> {
  return sparkiiApi<ConfigSchemaResponse>({
    ...profileScoped(profile),
    path: '/api/config/schema'
  })
}

export function saveSparkiiConfig(config: SparkiiConfigRecord, profile?: null | string): Promise<{ ok: boolean }> {
...
export function getEnvVars(profile?: null | string): Promise<Record<string, EnvVarInfo>> {
  return sparkiiApi<Record<string, EnvVarInfo>>({
    ...profileScoped(profile),
    path: '/api/env'
  })
}
...
export function validateProviderCredential(
  ...
  return sparkiiApi<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function getCustomEndpoints(): Promise<CustomEndpointsResponse> {
  return sparkiiApi<CustomEndpointsResponse>({
    ...profileScoped(),
...
export function validateCustomEndpoint(endpoint: CustomEndpointUpdate): Promise<CustomEndpointValidationResponse> {
  return sparkiiApi<CustomEndpointValidationResponse>({
...
export function activateCustomEndpoint(id: string): Promise<{ ok: boolean; provider: string; model: string }> {
  return sparkiiApi<{ ok: boolean; provider: string; model: string }>({
    ...profileScoped(),
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return sparkiiApi<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function disconnectOAuthProvider(providerId: string): Promise<{ ok: boolean; provider: string }> {
  return sparkiiApi<{ ok: boolean; provider: string }>({
    ...profileScoped(),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return sparkiiApi<OAuthSubmitResponse>({
    ...profileScoped(),
