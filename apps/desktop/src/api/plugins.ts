...
import { getApiRequestConnection, getApiRequestProfile, sparkiiApi, profileScoped } from './client'
...
async function activeConnection(): Promise<SparkiiConnection> {
  ...
  return window.sparkiiDesktop.getConnection(getApiRequestProfile())
}
