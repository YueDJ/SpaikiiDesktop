...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@sparkii/plugin-sdk'
...
/** First-class Sparkii projects, for scoping a board's default workspace. */
