...
test('generated protocol uses sparkii profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `sparkii profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `sparkii profiles list` for the LIVE/)
})
