...
import type * as SparkiiApi from '@/sparkii'
...
// observable.
vi.mock('@/sparkii', async importOriginal => ({
  ...(await importOriginal<typeof SparkiiApi>()),
...
describe('SkillsView toolset management', () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'sparkii-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://sparkii-agent.nousresearch.com'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { sparkiiDesktop?: unknown }).sparkiiDesktop = { connections, getAgentRoster }
