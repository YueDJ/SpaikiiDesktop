...
function fontFamilyFromConfig(config: SparkiiConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const [staleConfig, setStaleConfig] = useState<SparkiiConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setSparkiiConfigCache, so
