...
import type { ConfigFieldSchema, SparkiiConfigRecord, ToolsetInfo } from '@/types/sparkii'
...
export function getNested(obj: SparkiiConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: SparkiiConfigRecord, next: SparkiiConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: SparkiiConfigRecord): boolean {
...
export function setNested(obj: SparkiiConfigRecord, path: string, value: unknown): SparkiiConfigRecord {
...
function personalityOptions(config: SparkiiConfigRecord): string[] {
...
function commandProviderNames(config: SparkiiConfigRecord, section: 'tts' | 'stt'): string[] {
