...
export function ConfigSettings({
  ...
  const { data: loadedConfig, isError: configLoadFailed, refetch: refetchConfig } = useSparkiiConfigRecord()
  ...
  useEffect(() => {
    ...
    const t = window.setTimeout(() => {
      void (async () => {
        try {
          const result = await saveSparkiiConfig(config)
