...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/sparkii'
...
const VERSION = 3
const PREFIX = 'HML' // "Sparkii Memory Loadout" — namespaces our codes like WoW's leading bytes.
