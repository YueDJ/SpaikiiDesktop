import type { SparkiiReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SparkiiReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SparkiiReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
