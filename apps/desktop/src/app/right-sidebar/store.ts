...
const TAKEOVER_KEY = 'sparkii.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Sparkii can't clear via the API — the user
 *  sees exactly what runs instead of Sparkii silently deleting their creds. */
