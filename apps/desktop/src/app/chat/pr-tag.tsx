...
export function openPullRequest(pr: SparkiiBranchPullRequest): void {
  if (pr.url) {
    void window.sparkiiDesktop?.openExternal?.(pr.url)
  }
}
 ...
 *  never a status dot. */
export function PrTag({ className, pr }: { className?: string; pr: SparkiiBranchPullRequest }) {
