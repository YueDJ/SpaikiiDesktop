...
import type { SparkiiGitBranch } from '@/global'
...
const branchActionLabel = (branch: SparkiiGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<SparkiiGitBranch[]>([])
  ...
  const convert = async (branch: SparkiiGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
