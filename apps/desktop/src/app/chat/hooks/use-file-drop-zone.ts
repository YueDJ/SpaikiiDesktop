...
import { type DroppedFile, extractDroppedFiles, SPARKII_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, SPARKII_PATHS_MIME) ? 'files' : null
