...
// (#73044). Exercises the REAL sparkii + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/sparkii')
...
const conn = (over: Partial<SparkiiConnection> = {}): SparkiiConnection =>
  ({
    authMode: 'oauth',
