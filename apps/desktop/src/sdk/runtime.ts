 ...
 * plugins resolve `@sparkii/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SPARKII_PLUGIN_SDK__: sdk,
  __SPARKII_REACT__: React,
  __SPARKII_REACT_JSX__: jsxRuntime,
  __SPARKII_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@sparkii/plugin-sdk': shimUrl('__SPARKII_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SPARKII_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SPARKII_REACT_JSX__'),
    react: shimUrl('__SPARKII_REACT__')
  }
