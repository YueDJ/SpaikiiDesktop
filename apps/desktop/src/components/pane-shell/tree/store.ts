...
const STORAGE_KEY = 'sparkii.desktop.layoutTree.v2'

writeKey('sparkii.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('sparkii.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('sparkii.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'sparkii.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'sparkii.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'sparkii.desktop.hiddenStripTabs.v1'
...
writeKey('sparkii.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SPARKII_LAYOUT_TREE__ = {
    close: closeTreePane,
