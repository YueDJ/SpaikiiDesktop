...
function identityForConnection(connection: SparkiiConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: SparkiiConnection | null): void {
