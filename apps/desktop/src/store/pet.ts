...
export interface PetInfo {
  ...
  // the Sparkii "run" activity state uses the in-place running row).
 ...
 * SPARKII_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'sparkii.desktop.pet-roam.v1'
