...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('sparkii.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('sparkii.desktop.unreadFinishedSessions')
