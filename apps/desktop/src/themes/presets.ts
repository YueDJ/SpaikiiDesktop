...
const SYSTEM_SANS =
  '"Noto Sans SC", "Segoe WPC", "Segoe UI", -apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", system-ui, sans-serif, ' +
  EMOJI_FALLBACK
...
/**
 * Nous — canonical Sparkii desktop identity. The palette keeps the current
