 ...
 * `<sparkii home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'sparkii.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'sparkii.desktop.disabledPlugins.v1'
