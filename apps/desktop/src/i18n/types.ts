...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshSparkiiPathTitle: string
      sshSparkiiPathDesc: string
      sshSparkiiPathPlaceholder: string
  ...
  commandCenter: {
    ...
    sparkiiActiveSessions: (version: string, count: number) => string
