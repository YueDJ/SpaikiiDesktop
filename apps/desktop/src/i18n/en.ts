...
export const en: Translations = {
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the Sparkii backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Sparkii backend elsewhere. Per-profile overrides below.',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Sparkii ${version} · Active sessions ${count}`,
