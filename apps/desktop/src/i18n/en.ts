...
export const en: Translations = {
  ...
  notifications: {
    ...
    native: {
      ...
      inputBody: 'Sparkii is waiting for your response.',
      turnDoneTitle: 'Sparkii finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Sparkii defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Sparkii backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.sparkii/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Sparkii is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Sparkii asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Sparkii was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Sparkii was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Sparkii follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Sparkii can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Sparkii is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Sparkii, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Sparkii runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Sparkii checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Sparkii configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Sparkii.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Sparkii gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Sparkii Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Sparkii Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Sparkii runtime managed by this app.',
      kindRemoteDesc: 'A Sparkii gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Sparkii Cloud account.',
      kindSshDesc: 'A Sparkii install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Sparkii manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Sparkii Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Sparkii backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SPARKII_DESKTOP_REMOTE_URL and SPARKII_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Sparkii backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Sparkii backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Sparkii Cloud',
      cloudDesc: 'Sign in once to Sparkii Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Sparkii Cloud',
      cloudSignIn: 'Sign in to Sparkii Cloud',
      cloudSignedIn: 'Signed in to Sparkii Cloud',
      cloudNeedsSignIn: 'Sign in to Sparkii Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Sparkii Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Sparkii Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Sparkii Cloud',
      cloudSignedOutMessage: 'Cleared the Sparkii Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /sparkii.',
      ...
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Sparkii ${version}` : ''}`,
      ...
      sshDesc:
        'Sparkii is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshSparkiiPathTitle: 'Sparkii path (optional)',
      sshSparkiiPathDesc: 'Full path to the remote sparkii binary. Blank = auto-detect.',
      sshSparkiiPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Sparkii found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Sparkii runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Sparkii is not installed on the remote host. Install it there (curl -fsSL https://sparkii-agent.nousresearch.com/install.sh | sh) or set the Sparkii path.',
      sshErrPlatform:
        'Unsupported remote platform. Sparkii Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Sparkii on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Sparkii. Review the exact configuration below — it comes from the link, not from Sparkii.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Sparkii runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Sparkii at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via sparkii curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Sparkii builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Sparkii to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Sparkii to generate pets.',
      backgroundHint: 'You can close this — Sparkii will notify you when it’s done.',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@sparkii:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Sparkii environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Sparkii did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Sparkii will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Sparkii backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Sparkii. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Sparkii backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Sparkii...',
    placeholderReconnecting: 'Reconnecting to Sparkii…',
    ...
    attachUrlDesc: 'Sparkii will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Sparkii to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Sparkii…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Sparkii…',
    ...
    unsupportedMessage: 'This version of Sparkii can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Sparkii from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Sparkii will pick up the new version next time you launch it.',
    ...
    applyingBody:
      'The Sparkii updater takes over in its own window and reopens Sparkii automatically when it’s done. Please don’t reopen Sparkii yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Sparkii reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Sparkii reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Sparkii?',
    blockerBody:
      'Sparkii needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Sparkii',
    foreignBlockerBody:
      'Sparkii can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Sparkii can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Sparkii needs a one-time install',
    ...
    setupChoiceDesc:
      'Connect this app to a Sparkii gateway you already run, or install Sparkii locally on this computer.',
    connectExistingTitle: 'Connect to existing Sparkii',
    ...
    installLocalTitle: 'Install Sparkii locally',
    installLocalDesc: 'Download Sparkii, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Sparkii Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Sparkii',
    ...
    remoteUrlDesc: 'Use the base URL of the Sparkii gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/sparkii',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Sparkii gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Sparkii Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Sparkii CLI or desktop instance is running. Stop any running Sparkii instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Sparkii Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Sparkii is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Sparkii…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Sparkii',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Sparkii at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Sparkii connects automatically',
    ...
    authorizeThere: 'Authorize Sparkii there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Sparkii there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Sparkii Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Sparkii will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Sparkii is restarting...',
      askRestart: 'Ask Sparkii to restart the server',
      lookingRestart: taskId => `Sparkii is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Sparkii is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Sparkii to open a page.',
      finishedRestarting: message => `Sparkii finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Sparkii could not restart the server.',
      stillWorking:
        'Sparkii is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Sparkii is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Sparkii gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.sparkii/config.yaml). Sparkii won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Sparkii needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Sparkii needs a credential to continue.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `sparkii gateway` running?'
    }
  },
