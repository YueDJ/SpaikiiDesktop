...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @sparkii/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@sparkii/shared'],
              message: 'Plugins import only @sparkii/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
