...
// even though a fresh shell — and the Sparkii CLI — sees it immediately. The
// desktop's SPARKII_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\sparkii. Reading
...
//       SPARKII_HOME    REG_SZ    F:\Sparkii\data
//
