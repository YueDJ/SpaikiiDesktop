 ...
 *
 * A public install can end up with `origin=git@github.com:YueDJ/SpaikiiDesktop.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/YueDJ/SpaikiiDesktop.git'
