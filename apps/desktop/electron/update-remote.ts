 ...
 *
 * A public install can end up with `origin=git@github.com:YueDJ/SparkiiDesktop.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/YueDJ/SparkiiDesktop.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/yuedj/spaikiidesktop'
