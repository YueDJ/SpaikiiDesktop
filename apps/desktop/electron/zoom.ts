...
export const ZOOM_STORAGE_KEY = 'sparkii:desktop:zoomLevel'
 ...
 * but forgot to emit 'sparkii:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('sparkii:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
