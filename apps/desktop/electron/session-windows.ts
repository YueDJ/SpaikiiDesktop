...
// by main.ts (`setBackgroundThrottling` driven by the merged `sparkii:active-work`
...
// (the "Sparkii idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Sparkii" wake word has NO preceding click,
