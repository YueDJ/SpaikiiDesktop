 ...
 * startSparkii() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startSparkii() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startSparkii`, re-emits
