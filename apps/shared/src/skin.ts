/**
 * Canonical Sparkii skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SPARKII_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`sparkii_cli/skin_engine.py`),
 ...
 *   • CLI     → `sparkii_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
