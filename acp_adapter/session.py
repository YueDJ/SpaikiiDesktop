...
def _normalize_cwd_for_compare(cwd: str | None) -> str:
    ...
    from sparkii_constants import windows_path_to_wsl
...
def _expand_acp_enabled_toolsets(
    ...
    expanded: List[str] = []
    for name in list(toolsets or ["sparkii-acp"]):
...
class SessionManager:
    ...
    def _get_db(self):
        ...
        Note: we resolve ``SPARKII_HOME`` dynamically rather than relying on
        ...
        later (e.g. by the test fixture ``_isolate_sparkii_home``).
        """
    ...
    def _restore(self, session_id: str) -> Optional[SessionState]:
        ...
        # for the rest of the session (see sparkii_state.get_messages_as_conversation).
        try:
